...
namespace pydsdoc
{
    namespace nvmeta
    {
        namespace MetaTypeDoc
        {
            ...
            /*added code for reid*/
            constexpr const char* NVDS_TRACKER_BATCH_REID_META=R"pyds(Metadata type to be set for tracking ReID vectors for the whole batch generated by tracker)pyds";
            constexpr const char* NVDS_TRACKER_OBJ_REID_META=R"pyds(Metadata type to be set for ReID information for a single object generated by tracker.)pyds";
        }    
